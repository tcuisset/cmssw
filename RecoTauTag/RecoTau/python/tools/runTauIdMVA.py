...
#Adding DeepBoostedTau name and Model Files locations - Changes by Ganesh 
        if "deepTau2018v2p7" in self.toKeep:
            if self.debug: print ("Adding DeepTau Boostedv2p7 IDs : should be used for reconstructed BoostedTaus")
