...
std::vector<float> DNNInputAlessandroV1::computeVector(ticl::Trackster const& ts_base,
...
std::vector<float> DNNInputAlessandroV2::computeVector(ticl::Trackster const& ts_base,
                                                       ticl::Trackster const& ts_toCluster) {
