...
# Currently Mustache for HGCAL does not produce tracksters, therefore we cannot use the tracksterSimTracksterAssociation on superclusters
(ticl_v5 & ~ticl_v5_mustache).toModify(hgcalAssociators, lambda x: x.add(tracksterSimTracksterAssociationLinkingSuperclustering, tracksterSimTracksterAssociationPRSuperclustering))
