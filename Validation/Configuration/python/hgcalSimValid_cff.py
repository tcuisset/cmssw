...
hgcalAssociators = cms.Task(lcAssocByEnergyScoreProducer, layerClusterCaloParticleAssociationProducer,
                            ...
                            tracksterSimTracksterAssociationLinkingbyCLUE3DEM, tracksterSimTracksterAssociationPRbyCLUE3DEM,
                            tracksterSimTracksterAssociationLinkingSuperclustering, tracksterSimTracksterAssociationPRSuperclustering,
