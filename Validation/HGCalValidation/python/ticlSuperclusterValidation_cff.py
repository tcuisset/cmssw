...
tracksterIteration = "ticlTrackstersCLUE3DHigh"
simTrackstersCollection = "ticlSimTrackstersfromCPs"
...
ticlValidSuperclusteringSeedMask = _tracksterAssociationMaskProducer.clone(
    tracksters=cms.InputTag(tracksterIteration),
    associatorRecoToSim=cms.InputTag(f"allTrackstersToSimTrackstersAssociationsByLCs:{tracksterIteration}To{simTrackstersCollection}"),
    associatorSimToReco=cms.InputTag(f"allTrackstersToSimTrackstersAssociationsByLCs:{simTrackstersCollection}To{tracksterIteration}"),
