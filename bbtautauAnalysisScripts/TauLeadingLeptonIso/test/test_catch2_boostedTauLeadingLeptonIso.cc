...
static constexpr auto s_tag = "[boostedTauLeadingLeptonIso]";

TEST_CASE("Standard checks of boostedTauLeadingLeptonIso", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("boostedTauLeadingLeptonIso"
