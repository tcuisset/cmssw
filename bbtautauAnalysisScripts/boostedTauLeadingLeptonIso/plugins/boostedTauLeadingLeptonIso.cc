...
int16_t nanoAodCollection_idx = -1; // Index into NanoAOD collection of lepton
};
...
class boostedTauLeadingLeptonIso : public edm::stream::EDProducer<> {
  ...
  edm::EDGetTokenT< edm::RefVector<std::vector<pat::Muon>> > linkedMuonCollection;
  edm::EDGetTokenT< std::vector<pat::Electron> > electronCollection;
  edm::EDGetTokenT< edm::RefVector<std::vector<pat::Electron>> > linkedElectronCollection;
...
boostedTauLeadingLeptonIso::boostedTauLeadingLeptonIso(const edm::ParameterSet& iConfig):
  ...
  linkedMuonCollection(consumes< edm::RefVector<std::vector<pat::Muon>> >({"finalMuons", ""})),
  electronCollection(consumes< std::vector<pat::Electron> >(iConfig.getParameter< edm::InputTag >("electronCollection"))),
  linkedElectronCollection(consumes< edm::RefVector<std::vector<pat::Electron>> >({"finalElectrons", ""})),
  ...
  theEffectiveAreas(iConfig.getParameter< edm::FileInPath>("EAConfigFile").fullPath())
{
  ...
  produces<edm::ValueMap<int>>("LeadingMuonmuonIdx");
  ...
  produces<edm::ValueMap<int>>("SubLeadingMuonmuonIdx");
  ...
  produces<edm::ValueMap<int>>("SubSubLeadingMuonmuonIdx");
  ...
  produces<edm::ValueMap<int>>("LeadingElectronelectronIdx");
  ...
  produces<edm::ValueMap<int>>("SubLeadingElectronelectronIdx");
  ...
  produces<edm::ValueMap<int>>("SubSubLeadingElectronelectronIdx");
...
boostedTauLeadingLeptonIso::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   edm::Handle< edm::RefVector<std::vector<pat::Muon>> > nanoFinalMuonHandle;
   iEvent.getByToken(linkedMuonCollection, nanoFinalMuonHandle);

   edm::Handle< std::vector<pat::Electron> > electronHandle;
   iEvent.getByToken(electronCollection, electronHandle);
   edm::Handle< edm::RefVector<std::vector<pat::Electron>> > nanoFinalElectronHandle;
   iEvent.getByToken(linkedElectronCollection, nanoFinalElectronHandle);
   ...
   std::vector<int16_t> leadingMuonVector_muon_idx, subleadingMuonVector_muon_idx, subsubleadingMuonVector_muon_idx;
   ...
   std::vector<int16_t> leadingElectronVector_electron_idx, subleadingElectronVector_electron_idx, subsubleadingElectronVector_electron_idx;
   ...
   for(std::vector<pat::Tau>::const_iterator theBoostedTau = boostedTauHandle->begin();
      ...
      ++theMuon)
    {
     ...
     {
              // Look for associated NanoAOD collection index (not the same as muon collection since nano muons are filtered)
      for (auto nanoMuonRef_it = nanoFinalMuonHandle->begin(); nanoMuonRef_it != nanoFinalMuonHandle->end(); ++nanoMuonRef_it) {
        if (nanoMuonRef_it->key() == theMuon - muonHandle->begin()) {
          currentMuonInfo.nanoAodCollection_idx = nanoMuonRef_it - nanoFinalMuonHandle->begin();
          break;
        }
      }
      ...
      ++theElectron)
    {
     ...
     {
      // Look for associated NanoAOD collection index (not the same as electron collection since nano electrons are filtered)
      for (auto nanoElectronRef_it = nanoFinalElectronHandle->begin(); nanoElectronRef_it != nanoFinalElectronHandle->end(); ++nanoElectronRef_it) {
        if (nanoElectronRef_it->key() == theElectron - electronHandle->begin()) {
          currentElectronInfo.nanoAodCollection_idx = nanoElectronRef_it - nanoFinalElectronHandle->begin();
          break;
        }
      }
       ...
       for (int i=0; i<nullElectronEntriesNeeded;++i)
    {
      ...
      //Add delR info for muons
       ...
       leadingMuonVector_muon_idx.push_back(muonInformation[0].nanoAodCollection_idx);
       subleadingMuonVector_muon_idx.push_back(muonInformation[1].nanoAodCollection_idx);
       subsubleadingMuonVector_muon_idx.push_back(muonInformation[2].nanoAodCollection_idx); 
      ...
      //Add delR info for electrons
       ...
       leadingElectronVector_electron_idx.push_back(electronInformation[0].nanoAodCollection_idx);
       subleadingElectronVector_electron_idx.push_back(electronInformation[1].nanoAodCollection_idx);
       subsubleadingElectronVector_electron_idx.push_back(electronInformation[2].nanoAodCollection_idx);
   ...
   filler_leadingMuonVector_sumPFChargedHadronPt_valueMap.insert(boostedTauHandle, leadingMuonVector_sumPFChargedHadronPt.begin(), leadingMuonVector_sumPFChargedHadronPt.end());
   ...
   filler_leadingMuonVector_sumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, leadingMuonVector_sumPFNeutralHadronPt.begin(), leadingMuonVector_sumPFNeutralHadronPt.end());
   ...
   filler_leadingMuonVector_sumPFPhotonPt_valueMap.insert(boostedTauHandle, leadingMuonVector_sumPFPhotonPt.begin(), leadingMuonVector_sumPFPhotonPt.end());
   ...
   filler_leadingMuonVector_sumPUPt_valueMap.insert(boostedTauHandle, leadingMuonVector_sumPUPt.begin(), leadingMuonVector_sumPUPt.end());
   ...
   filler_leadingMuonVector_tausumPFChargedHadronPt_valueMap.insert(boostedTauHandle, leadingMuonVector_tausumPFChargedHadronPt.begin(), leadingMuonVector_tausumPFChargedHadronPt.end());
   ...
   filler_leadingMuonVector_tausumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, leadingMuonVector_tausumPFNeutralHadronPt.begin(), leadingMuonVector_tausumPFNeutralHadronPt.end());
   ...
   filler_leadingMuonVector_tausumPFPhotonPt_valueMap.insert(boostedTauHandle, leadingMuonVector_tausumPFPhotonPt.begin(), leadingMuonVector_tausumPFPhotonPt.end());
   ...
   filler_subleadingMuonVector_sumPFChargedHadronPt_valueMap.insert(boostedTauHandle, subleadingMuonVector_sumPFChargedHadronPt.begin(), subleadingMuonVector_sumPFChargedHadronPt.end());
   ...
   filler_subleadingMuonVector_sumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, subleadingMuonVector_sumPFNeutralHadronPt.begin(), subleadingMuonVector_sumPFNeutralHadronPt.end());
   ...
   filler_subleadingMuonVector_sumPFPhotonPt_valueMap.insert(boostedTauHandle, subleadingMuonVector_sumPFPhotonPt.begin(), subleadingMuonVector_sumPFPhotonPt.end());
   ...
   filler_subleadingMuonVector_sumPUPt_valueMap.insert(boostedTauHandle, subleadingMuonVector_sumPUPt.begin(), subleadingMuonVector_sumPUPt.end());
   ...
   filler_subleadingMuonVector_tausumPFChargedHadronPt_valueMap.insert(boostedTauHandle, subleadingMuonVector_tausumPFChargedHadronPt.begin(), subleadingMuonVector_tausumPFChargedHadronPt.end());
   ...
   filler_subleadingMuonVector_tausumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, subleadingMuonVector_tausumPFNeutralHadronPt.begin(), subleadingMuonVector_tausumPFNeutralHadronPt.end());
   ...
   filler_subleadingMuonVector_tausumPFPhotonPt_valueMap.insert(boostedTauHandle, subleadingMuonVector_tausumPFPhotonPt.begin(), subleadingMuonVector_tausumPFPhotonPt.end());
   ...
   filler_subsubleadingMuonVector_sumPFChargedHadronPt_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_sumPFChargedHadronPt.begin(), subsubleadingMuonVector_sumPFChargedHadronPt.end());
   ...
   filler_subsubleadingMuonVector_sumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_sumPFNeutralHadronPt.begin(), subsubleadingMuonVector_sumPFNeutralHadronPt.end());
   ...
   filler_subsubleadingMuonVector_sumPFPhotonPt_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_sumPFPhotonPt.begin(), subsubleadingMuonVector_sumPFPhotonPt.end());
   ...
   filler_subsubleadingMuonVector_sumPUPt_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_sumPUPt.begin(), subsubleadingMuonVector_sumPUPt.end());
   ...
   filler_subsubleadingMuonVector_tausumPFChargedHadronPt_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_tausumPFChargedHadronPt.begin(), subsubleadingMuonVector_tausumPFChargedHadronPt.end());
   ...
   filler_subsubleadingMuonVector_tausumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_tausumPFNeutralHadronPt.begin(), subsubleadingMuonVector_tausumPFNeutralHadronPt.end());
   ...
   filler_subsubleadingMuonVector_tausumPFPhotonPt_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_tausumPFPhotonPt.begin(), subsubleadingMuonVector_tausumPFPhotonPt.end());
   filler_subsubleadingMuonVector_tausumPFPhotonPt_valueMap.fill();   

   std::unique_ptr< edm::ValueMap < int > > leadingMuonVector_muon_idx_valueMap(new edm::ValueMap < int >());
   edm::ValueMap< int >::Filler filler_leadingMuonVector_muon_idx_valueMap(*leadingMuonVector_muon_idx_valueMap);
   filler_leadingMuonVector_muon_idx_valueMap.insert(boostedTauHandle, leadingMuonVector_muon_idx.begin(), leadingMuonVector_muon_idx.end());
   filler_leadingMuonVector_muon_idx_valueMap.fill(); 
   
   std::unique_ptr< edm::ValueMap < int > > subleadingMuonVector_muon_idx_valueMap(new edm::ValueMap < int >());
   edm::ValueMap< int >::Filler filler_subleadingMuonVector_muon_idx_valueMap(*subleadingMuonVector_muon_idx_valueMap);
   filler_subleadingMuonVector_muon_idx_valueMap.insert(boostedTauHandle, subleadingMuonVector_muon_idx.begin(), subleadingMuonVector_muon_idx.end());
   filler_subleadingMuonVector_muon_idx_valueMap.fill(); 

   std::unique_ptr< edm::ValueMap < int > > subsubleadingMuonVector_muon_idx_valueMap(new edm::ValueMap < int >());
   edm::ValueMap< int >::Filler filler_subsubleadingMuonVector_muon_idx_valueMap(*subsubleadingMuonVector_muon_idx_valueMap);
   filler_subsubleadingMuonVector_muon_idx_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_muon_idx.begin(), subsubleadingMuonVector_muon_idx.end());
   filler_subsubleadingMuonVector_muon_idx_valueMap.fill(); 
  ...
  //Adding ELECTRONS value Maps - Stuff that was not originally inlcuded by Andrew
   ...
   filler_leadingElectronVector_sumPFChargedHadronPt_valueMap.insert(boostedTauHandle, leadingElectronVector_sumPFChargedHadronPt.begin(), leadingElectronVector_sumPFChargedHadronPt.end());
   ...
   filler_leadingElectronVector_sumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, leadingElectronVector_sumPFNeutralHadronPt.begin(), leadingElectronVector_sumPFNeutralHadronPt.end());
   ...
   filler_leadingElectronVector_sumPFPhotonPt_valueMap.insert(boostedTauHandle, leadingElectronVector_sumPFPhotonPt.begin(), leadingElectronVector_sumPFPhotonPt.end());
   ...
   filler_leadingElectronVector_tausumPFChargedHadronPt_valueMap.insert(boostedTauHandle, leadingElectronVector_tausumPFChargedHadronPt.begin(), leadingElectronVector_tausumPFChargedHadronPt.end());
   ...
   filler_leadingElectronVector_tausumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, leadingElectronVector_tausumPFNeutralHadronPt.begin(), leadingElectronVector_tausumPFNeutralHadronPt.end());
   ...
   filler_leadingElectronVector_tausumPFPhotonPt_valueMap.insert(boostedTauHandle, leadingElectronVector_tausumPFPhotonPt.begin(), leadingElectronVector_tausumPFPhotonPt.end());
   ...
   filler_subleadingElectronVector_sumPFChargedHadronPt_valueMap.insert(boostedTauHandle, subleadingElectronVector_sumPFChargedHadronPt.begin(), subleadingElectronVector_sumPFChargedHadronPt.end());
   ...
   filler_subleadingElectronVector_sumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, subleadingElectronVector_sumPFNeutralHadronPt.begin(), subleadingElectronVector_sumPFNeutralHadronPt.end());
   ...
   filler_subleadingElectronVector_sumPFPhotonPt_valueMap.insert(boostedTauHandle, subleadingElectronVector_sumPFPhotonPt.begin(), subleadingElectronVector_sumPFPhotonPt.end());
   ...
   filler_subleadingElectronVector_tausumPFChargedHadronPt_valueMap.insert(boostedTauHandle, subleadingElectronVector_tausumPFChargedHadronPt.begin(), subleadingElectronVector_tausumPFChargedHadronPt.end());
   ...
   filler_subleadingElectronVector_tausumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, subleadingElectronVector_tausumPFNeutralHadronPt.begin(), subleadingElectronVector_tausumPFNeutralHadronPt.end());
   ...
   filler_subleadingElectronVector_tausumPFPhotonPt_valueMap.insert(boostedTauHandle, subleadingElectronVector_tausumPFPhotonPt.begin(), subleadingElectronVector_tausumPFPhotonPt.end());
   ...
   filler_subsubleadingElectronVector_sumPFChargedHadronPt_valueMap.insert(boostedTauHandle, subsubleadingElectronVector_sumPFChargedHadronPt.begin(), subsubleadingElectronVector_sumPFChargedHadronPt.end());
   ...
   filler_subsubleadingElectronVector_sumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, subsubleadingElectronVector_sumPFNeutralHadronPt.begin(), subsubleadingElectronVector_sumPFNeutralHadronPt.end());
   ...
   filler_subsubleadingElectronVector_sumPFPhotonPt_valueMap.insert(boostedTauHandle, subsubleadingElectronVector_sumPFPhotonPt.begin(), subsubleadingElectronVector_sumPFPhotonPt.end());
   ...
   filler_subsubleadingElectronVector_tausumPFChargedHadronPt_valueMap.insert(boostedTauHandle, subsubleadingElectronVector_tausumPFChargedHadronPt.begin(), subsubleadingElectronVector_tausumPFChargedHadronPt.end());
   ...
   filler_subsubleadingElectronVector_tausumPFNeutralHadronPt_valueMap.insert(boostedTauHandle, subsubleadingElectronVector_tausumPFNeutralHadronPt.begin(), subsubleadingElectronVector_tausumPFNeutralHadronPt.end());
   ...
   filler_subsubleadingElectronVector_tausumPFPhotonPt_valueMap.insert(boostedTauHandle, subsubleadingElectronVector_tausumPFPhotonPt.begin(), subsubleadingElectronVector_tausumPFPhotonPt.end());
   filler_subsubleadingElectronVector_tausumPFPhotonPt_valueMap.fill(); 


   std::unique_ptr< edm::ValueMap < int > > leadingElectronVector_electron_idx_valueMap(new edm::ValueMap < int >());
   edm::ValueMap< int >::Filler filler_leadingElectronVector_electron_idx_valueMap(*leadingElectronVector_electron_idx_valueMap);
   filler_leadingElectronVector_electron_idx_valueMap.insert(boostedTauHandle, leadingElectronVector_electron_idx.begin(), leadingElectronVector_electron_idx.end());
   filler_leadingElectronVector_electron_idx_valueMap.fill(); 
   
   std::unique_ptr< edm::ValueMap < int > > subleadingElectronVector_electron_idx_valueMap(new edm::ValueMap < int >());
   edm::ValueMap< int >::Filler filler_subleadingElectronVector_electron_idx_valueMap(*subleadingElectronVector_electron_idx_valueMap);
   filler_subleadingElectronVector_electron_idx_valueMap.insert(boostedTauHandle, subleadingElectronVector_electron_idx.begin(), subleadingElectronVector_electron_idx.end());
   filler_subleadingElectronVector_electron_idx_valueMap.fill(); 

   std::unique_ptr< edm::ValueMap < int > > subsubleadingElectronVector_electron_idx_valueMap(new edm::ValueMap < int >());
   edm::ValueMap< int >::Filler filler_subsubleadingElectronVector_electron_idx_valueMap(*subsubleadingElectronVector_electron_idx_valueMap);
   filler_subsubleadingElectronVector_electron_idx_valueMap.insert(boostedTauHandle, subsubleadingElectronVector_electron_idx.begin(), subsubleadingElectronVector_electron_idx.end());
   filler_subsubleadingElectronVector_electron_idx_valueMap.fill(); 
   ...
   filler_leadingMuonVector_delR_valueMap.insert(boostedTauHandle, leadingMuonVector_delR.begin(), leadingMuonVector_delR.end());
   ...
   filler_subleadingMuonVector_delR_valueMap.insert(boostedTauHandle, subleadingMuonVector_delR.begin(), subleadingMuonVector_delR.end());
   ...
   filler_subsubleadingMuonVector_delR_valueMap.insert(boostedTauHandle, subsubleadingMuonVector_delR.begin(), subsubleadingMuonVector_delR.end());
  ...
  //delR for electrons valuemaps (for all three cases leading, subleading and subsubleading)
   ...
   filler_leadingElectronVector_delR_valueMap.insert(boostedTauHandle, leadingElectronVector_delR.begin(), leadingElectronVector_delR.end());
   ...
   filler_subleadingElectronVector_delR_valueMap.insert(boostedTauHandle, subleadingElectronVector_delR.begin(), subleadingElectronVector_delR.end());
   ...
   filler_subsubleadingElectronVector_delR_valueMap.insert(boostedTauHandle, subsubleadingElectronVector_delR.begin(), subsubleadingElectronVector_delR.end());
   ...
   iEvent.put(std::move(leadingMuonVector_muon_idx_valueMap), "LeadingMuonmuonIdx");
   ...
   iEvent.put(std::move(subleadingMuonVector_muon_idx_valueMap), "SubLeadingMuonmuonIdx");
   ...
   iEvent.put(std::move(subsubleadingMuonVector_muon_idx_valueMap), "SubSubLeadingMuonmuonIdx");   
   ...
   iEvent.put(std::move(leadingElectronVector_electron_idx_valueMap), "LeadingElectronelectronIdx");
   ...
   iEvent.put(std::move(subleadingElectronVector_electron_idx_valueMap), "SubLeadingElectronelectronIdx");
   ...
   iEvent.put(std::move(subsubleadingElectronVector_electron_idx_valueMap), "SubSubLeadingElectronelectronIdx");  
}
